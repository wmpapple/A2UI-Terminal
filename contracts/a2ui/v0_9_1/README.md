...
`urn:a2ui-terminal:catalog:basic:v1`, whose 13 components already existed before S3.1.
...
incremental batch, an accepted compatible v0.9 batch, incompatible protocol version,
