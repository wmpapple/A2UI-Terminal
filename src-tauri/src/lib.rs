...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::set_telemetry_settings,
            commands::export_event_dictionary,
            ...
            commands::get_processing_options,
            commands::probe_local_providers,
            commands::list_chat_sessions,
            commands::delete_chat_session,
            commands::pin_chat_session,
            commands::delete_result,
            commands::pin_result,
            commands::create_chat_session,
            commands::plan_context,
            commands::clear_context_index,
            commands::search_authorized_content,
            ...
            commands::save_a2ui_template,
            commands::list_a2ui_templates,
            commands::open_a2ui_template,
            commands::delete_a2ui_template,
