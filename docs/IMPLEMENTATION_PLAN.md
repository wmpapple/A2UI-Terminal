...
- **本机缺少 Rust**：在安装工具链前无法本机验证 Rust/Tauri；CI 是临时强制门槛。
...
| ------------------------------------ | -------- | ---------- |
| 阶段 0：实施计划                     | 待确认   |            |
| 阶段 1：M0-A 仓库与安全治理          | 等待验收 |            |
| 阶段 2：M0-B TypeScript 与前端模块化 | 未开始   |            |
| 阶段 3：M0-C Tauri 2 与安全持久化    | 未开始   |            |
| 阶段 4：M1-A 工作区与编辑器          | 未开始   |            |
| 阶段 5：M1-B Provider 与上下文       | 未开始   |            |
| 阶段 6：M1-C Patch/Diff/撤销         | 未开始   |            |
| 阶段 7：A2UI Runtime 基础            | 未开始   |            |

确认本计划后，下一步只执行“阶段 1：M0-A 仓库与安全治理”。阶段 1 验收完成后再次停止，等待确认。
